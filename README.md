...
Swiggy is an online food ordering and delivery platform which uses Swiggy Live API to fetch data. 
...
- Deployed Link:- [Enjoy the Experience](https://eatup.vercel.app/)
